...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      'import.meta.env.VITE_FIREBASE_FIRESTORE_DATABASE_ID': JSON.stringify(process.env.VITE_FIREBASE_FIRESTORE_DATABASE_ID || process.env.FIREBASE_FIRESTORE_DATABASE_ID || process.env.FIRESTORE_DATABASE_ID || ''),
    },
    server: {
